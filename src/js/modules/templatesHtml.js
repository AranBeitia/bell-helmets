    ...
    <section class="row g-3">
      <div class="col-md-6">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="shipment" id="freeShipment" value="0" >
          <label class="form-check-label" for="freeShipment">Free shipment (72H) ( no extra cost )</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="shipment" id="extraShipping" value="5" checked>
          <label class="form-check-label" for="extraShipping">Extra shipping (48h) ( +5 € )</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="shipment" id="premium" value="10" >
